<%@ Page Title="" Language="C#" MasterPageFile="~/MemberMaster.master" AutoEventWireup="true"
    CodeFile="CUSTOMERInsertUpdate.aspx.cs" Inherits="CUSTOMERInsertUpdate" %>
...
//            if (document.getElementById("<%=txtCUSTCPHONE.ClientID%>").value == "") {
//                alert("PHONE can not be blank");
//                document.getElementById("<%=txtCUSTCPHONE.ClientID%>").focus();
//                return false;
//            }



//            if (document.getElementById("<%=txtCUSTIDNUMBER.ClientID%>").value == "") {
//                alert("CUST ID NUMBER can not be blank");
//                document.getElementById("<%=txtCUSTIDNUMBER.ClientID%>").focus();
//                return false;
//            }

//            if (document.getElementById("<%=txtCUSTDOB.ClientID%>").value == "") {
//                alert("CUST DOB can not be blank");
//                document.getElementById("<%=txtCUSTDOB.ClientID%>").focus();
//                return false;
//            }
            return true;
        }
    ...
    <script type="text/javascript" src="App_Themes/Default/js/loginjs.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpMenu" runat="Server">
    <ul>
        <li><a href="SearchSenderPage.aspx">Search Sender</a></li>
        <li id="selected"><a href="CUSTOMERInsertUpdate.aspx?cUSTOMERID=0">Sender</a></li>
        ...
        <table style="width: 100%; table-layout: fixed;">
            ...
            <tr style="display:none;">
                ...
                <td>
                    ...
                    <%--<ajaxToolkit:AsyncFileUpload ID="uplFile" runat="server"  />--%>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <span class="regBoxbig">
                        <asp:Label ID="lblCUSTIDNUMBER" runat="server" Text="" CssClass="txtRegbig">
                        </asp:Label>
                    </span>
                </td>
            </tr>

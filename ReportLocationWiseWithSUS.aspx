<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMaster.master" AutoEventWireup="true" CodeFile="ReportLocationWiseWithSUS.aspx.cs" Inherits="AgentWiseReport" %>
       ...
       <table>
            ...
            <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chkLoadSUSCustmer" runat="server" Text="Load only the Transfer where SUS Customer found."/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <asp:HiddenField ID="hfCustomerIDnSUS" runat="server" />
                    </td>
                </tr>
            </table>
            ...
            <h1 style="font-size:15px; margin-bottom:10px">Location Wise Report With Red Marked SUS Customer</h1>
            <span style="padding:5px; border:2px solid Blue;"> <asp:LinkButton ID="lnkPrint" Text="Print" runat="server" OnClientClick="javascript:printIt(document.getElementById('printThis').innerHTML);"></asp:LinkButton>
                </span><br /><br />
                <a href="https://www.patriotagent.com/" target="_blank" style="color:Blue;text-decoration:underline;">Please Click here</a> For PATRIOT AGENT. <br />To Check the ID and DOB to Confirm that these following Suspecious Customer.
                <br /> 
                <div id='printThis'>
                                        ...
                                        <tr>
                                            ...
                                            <div style="padding:5px 10px">
                                               <asp:GridView ID="gvTRANS" runat="server" CssClass="innergrid" BorderStyle="None" GridLines="Horizontal" AutoGenerateColumns="false" ShowHeader="true">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Select" ControlStyle-Width="10px">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkSelect" runat="server" Visible='<%#Eval("IsSUS")%>'/>
                                                                <asp:HiddenField ID="hfCustomerID" runat="server" Value='<%#Eval("CUSTID")%>'/>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Customer Detail" ControlStyle-Width="180px">
                                                            <ItemTemplate>
                                                               <a href='CUSTOMERInsertUpdate.aspx?cUSTOMERID=<%#Eval("CUSTID")%>' target="_blank"> <asp:Label ID="lblCustomerDetail"  Font-Bold="false" runat="server" ForeColor="GREEN" Visible='<%#Eval("IsNotSUS")%>' Text='<%#Eval("CUSTDETAIL")%>'>
                                                                        </asp:Label> 
                                                                        <asp:Label ID="lblCustomerDetailSUS"  Font-Bold="false" ForeColor="RED" Visible='<%#Eval("IsSUS")%>' runat="server" Text='<%#Eval("CUSTDETAIL")%>'>
                                                                        </asp:Label> </a>                                                                
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
        ...
        <div align="center"><asp:Button ID="btnSUSCustomer" runat="server" Text="Make Not SUS Customer" 
                        onclick="btnSUSCustomer_Click" /></div>
    </div>
    </td>
        </tr>
    </table>

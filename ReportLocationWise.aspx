<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMaster.master" AutoEventWireup="true" CodeFile="ReportLocationWise.aspx.cs" Inherits="AgentWiseReport" %>
            ...
            <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="lblPrintLink" runat="server" Text=""></asp:Label>
                              <asp:Button ID="btnPrint" runat="server" Text="Download pdf" Visible="false"
                ...
                <tr runat="server" id="tr2">
                    ...
                    <td>
                        <asp:Button ID="btnCodeSearch" runat="server" Text="btnSearch" 
                            onclick="btnCodeSearch_Click" />
                             <asp:Label ID="lblCodeReport" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
            </table>

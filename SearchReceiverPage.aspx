<%@ Page Title="" Language="C#" MasterPageFile="~/MemberMaster.master" AutoEventWireup="true"
    CodeFile="SearchReceiverPage.aspx.cs" Inherits="SearchSenderPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMenu" runat="Server">
    <ul>
        ...
        <li id="selected"><a href="SearchReceiverPage.aspx">Search Receiver</a></li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainMemberContent" runat="Server">
    ...
    <!-- End: memberReg -->
    <div class="memberlist" style="overflow: scroll; max-height: 500px; width: 580px;">
        <!-- Begin: memberlist -->
    ...
    <asp:Panel ID="panAll" runat="server" CssClass="modalPopup">
        <center>
            <div style="height: 300px; width: 100%; overflow: scroll;">
                <h2>
                    Select the Receiver to which you want to switch the info..</h2>

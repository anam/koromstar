...
public partial class CUSTOMERInsertUpdate : System.Web.UI.Page
{
    ...
    private void showCUSTOMERData()
    {
        ...
        txtCUSTIDNUMBER.Text = cUSTOMER.CUSTIDNUMBER;
        if (cUSTOMER.CUSTIDNUMBER.Trim() != "")
        {
            lblCUSTIDNUMBER.Text = "<a target='_blank' href='" + cUSTOMER.CUSTIDNUMBER.Trim() + "'>See ID</a>";
        }
    ...
    protected void btnCheckSus_Click(object sender, EventArgs e)
    {

    }
    protected void btnPatriotAgent_Click(object sender, EventArgs e)
    {
        lblCheckSus.Text = "1";
    }
